...
class ReceiveImageTVC: UITableViewCell {
...
extension ReceiveImageTVC: UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
