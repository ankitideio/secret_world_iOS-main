...
import Foundation
// MARK: - CreateBusinessAcModel
struct CreateBusinessAcModel: Codable {
    let status, message: String?
    let statusCode: Int?
    let data: GetBusinessUserData?
}

// MARK: - DataClass
struct GetBusinessUserData: Codable {
