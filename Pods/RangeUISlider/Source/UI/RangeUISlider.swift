...
open class RangeUISlider: UIView, ProgrammaticKnobChangeDelegate, RangeUpdaterDelegate {
    ...
    public override func layoutSubviews() {
        ...
        let leftKnobFrame = components.knobs.leftKnob.frame
           let minLabelBackgroundViewFrame = CGRect(
               x: leftKnobFrame.midX - (minLabelBackgroundView.frame.width / 2),
               y: leftKnobFrame.maxY + 5, // adjust the vertical position as needed
               width: minLabelBackgroundView.frame.width,
               height: minLabelBackgroundView.frame.height
           )
           minLabelBackgroundView.frame = minLabelBackgroundViewFrame
    }
    private func updateMinLabelBackgroundView() {
        // Customize the appearance of minLabelBackgroundView as needed.
        minLabelBackgroundView.backgroundColor = UIColor.lightGray
        minLabelBackgroundView.layer.cornerRadius = 5.0 // Adjust corner radius as needed
    }
    ...
    // MARK: setup
    private var minLabelBackgroundView: UIView!
    private func setup() {
