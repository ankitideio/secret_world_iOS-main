...
//    }
    ...
    @IBInspectable open var lineHeight: CGFloat = 5 {
        didSet {
            updateLineHeight()
        }
    }
    ...
    private let minLabelBackgroundView: UIView = UIView()
    private let maxLabelBackgroundView: UIView = UIView()
    ...
    open override func layoutSubviews() {
        ...
        if handleTracking == .none {
            ...
            updateLabelPositions()
            let minLabelFrame = CGRect(x: minLabel.frame.origin.x - 10, // Adjust the values as needed
                                              y: minLabel.frame.origin.y - 10,
                                              width: minLabelTextSize.width + 30, // Adjust the values as needed
                                              height: minLabelTextSize.height + 10)
                   minLabelBackgroundView.frame = minLabelFrame
            let maxLabelFrame = CGRect(x: maxLabel.frame.origin.x - 10, // Adjust the values as needed
                                              y: maxLabel.frame.origin.y - 10,
                                              width: maxLabelTextSize.width + 30, // Adjust the values as needed
                                              height: maxLabelTextSize.height + 10)
                   maxLabelBackgroundView.frame = minLabelFrame
        }
    }
...
//            rightHandle.borderColor = handleBorderColor.map { $0.cgColor }
    ...
    private func updateLabelPositions() {
        ...
        let minLabelBackgroundFrame = CGRect(x: minLabel.frame.origin.x - 10, // Adjust the values as needed
                                                    y: minLabel.frame.origin.y - 10,
                                                    width: minLabelTextSize.width + 30, // Adjust the values as needed
                                                    height: minLabelTextSize.height + 10)
                minLabelBackgroundView.frame = minLabelBackgroundFrame
        
        let maxxLabelBackgroundFrame = CGRect(x: maxLabel.frame.origin.x - 10, // Adjust the values as needed
                                                    y: maxLabel.frame.origin.y - 10,
                                                    width: maxLabelTextSize.width + 30, // Adjust the values as needed
                                                    height: maxLabelTextSize.height + 10)
                maxLabelBackgroundView.frame = maxxLabelBackgroundFrame
